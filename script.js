var scores, activePlayer, dice, roundscore, winningScore;
...
function nextplayer(){
        ...
        if (activePlayer === 0 ){
            ...
            document.querySelector('.player-1').style.color= "rgb(114, 201, 15)";
        }else{
            activePlayer = 0;
            document.querySelector('.player-0').style.color= "rgb(114, 201, 15)";
...
function init(){
    ...
    winningScore = prompt('input the Winnig score for the game');
